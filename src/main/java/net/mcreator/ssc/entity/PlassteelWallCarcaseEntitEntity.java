...
public class PlassteelWallCarcaseEntitEntity extends PathfinderMob {
	public PlassteelWallCarcaseEntitEntity(EntityType<PlassteelWallCarcaseEntitEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
