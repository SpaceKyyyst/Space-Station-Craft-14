...
import net.mcreator.ssc.procedures.ChairEntity_TICProcedure;

public class ChairEntityEntity extends PathfinderMob {
	public ChairEntityEntity(EntityType<ChairEntityEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(true);
	...
	public void baseTick() {
		super.baseTick();
		ChairEntity_TICProcedure.execute(this.level(), this);
	}
