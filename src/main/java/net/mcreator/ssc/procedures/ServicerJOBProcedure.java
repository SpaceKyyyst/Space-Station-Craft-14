...
public class ServicerJOBProcedure {
			...
			Ssc14Mod.queueServerWork(1, () -> {
				if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Ssc14ModMenus.MenuAccessor _menu3 ? _menu3.getSlots().get(0).getItem() : ItemStack.EMPTY).getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY)
					...
					if (entity instanceof Player _player && _player.containerMenu instanceof Ssc14ModMenus.MenuAccessor _menu)
						_menu.sendMenuStateUpdate(_player, 0, "Job_Name", "\u0421\u0435\u0440\u0432\u0438\u0441\u043D\u044B\u0439 \u0440\u0430\u0431\u043E\u0442\u043D\u0438\u043A", true);
					(entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Ssc14ModMenus.MenuAccessor _menu141 ? _menu141.getSlots().get(1).getItem() : ItemStack.EMPTY).set(DataComponents.CUSTOM_NAME, Component
							.literal(("ID \u043A\u0430\u0440\u0442\u0430 (" + ((entity instanceof Player _entity140 && _entity140.containerMenu instanceof Ssc14ModMenus.MenuAccessor _menu140) ? _menu140.getMenuState(0, "Job_Name", "") : "") + ")")));
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
