...
public class VendAutGUIButton4Procedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if (false == getBlockNBTLogic(world, BlockPos.containing(x, y, z), "but_4") && 0 < itemFromBlockInventory(world, BlockPos.containing(x, y, z), 4).getCount()) {
			if (!world.isClientSide()) {
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockEntity _blockEntity = world.getBlockEntity(_bp);
				BlockState _bs = world.getBlockState(_bp);
				if (_blockEntity != null) {
					_blockEntity.getPersistentData().putBoolean("but_4", true);
				}
			...
			Ssc14Mod.queueServerWork(20, () -> {
				if (0 < itemFromBlockInventory(world, BlockPos.containing(x, y, z), 4).getCount()) {
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
						if (_blockEntity != null) {
							_blockEntity.getPersistentData().putBoolean("but_4", false);
						}
						if (world instanceof Level _level)
							_level.sendBlockUpdated(_bp, _bs, _bs, 3);
					}
					if (Direction.NORTH == (getDirectionFromBlockState((world.getBlockState(BlockPos.containing(x, y, z)))))) {
						if (world instanceof ServerLevel _level) {
							ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z + 0), (itemFromBlockInventory(world, BlockPos.containing(x, y, z), 4).copy()));
						...
						if (world instanceof ServerLevel _level) {
							ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0.5), (y + 0.5), (z - 1), (itemFromBlockInventory(world, BlockPos.containing(x, y, z), 4).copy()));
							entityToSpawn.setPickUpDelay(0);
							entityToSpawn.setUnlimitedLifetime();
							_level.addFreshEntity(entityToSpawn);
						}
						...
						if (world instanceof ServerLevel _level) {
							ItemEntity entityToSpawn = new ItemEntity(_level, (x + 0), (y + 0.5), (z + 0.5), (itemFromBlockInventory(world, BlockPos.containing(x, y, z), 4).copy()));
							entityToSpawn.setPickUpDelay(0);
							entityToSpawn.setUnlimitedLifetime();
							_level.addFreshEntity(entityToSpawn);
						}
						...
						if (world instanceof ServerLevel _level) {
							ItemEntity entityToSpawn = new ItemEntity(_level, (x + 1), (y + 0.5), (z + 0.5), (itemFromBlockInventory(world, BlockPos.containing(x, y, z), 4).copy()));
							entityToSpawn.setPickUpDelay(0);
							entityToSpawn.setUnlimitedLifetime();
							_level.addFreshEntity(entityToSpawn);
						}
					...
					if (!world.isClientSide()) {
						...
						BlockState _bs = world.getBlockState(_bp);
						if (_blockEntity != null) {
							_blockEntity.getPersistentData().putDouble("slot_4", (getBlockNBTNumber(world, BlockPos.containing(x, y, z), "slot_4") - 1));
						}
						if (world instanceof Level _level)
							_level.sendBlockUpdated(_bp, _bs, _bs, 3);
					}
					if (getBlockNBTNumber(world, BlockPos.containing(x, y, z), "slot_4") == 0) {
