	...
	public static String execute(LevelAccessor world, Entity entity) {
		...
		if (Ssc14ModBlocks.ROD_FLOOR.get() == (world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock()
			...
			loc_buf_t = "\u041A\u0443\u0441\u0430\u0447\u043A\u0438";
				...
				&& (3 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip30 ? (world.getBlockState(BlockPos.containing(X, Y, Z))).getValue(_getip30) : -1)
						|| 6 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip32
				...
				|| Ssc14ModBlocks.ARMORED_WINDOW.get() == (world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock()
						&& 2 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip36
			...
			loc_buf_t = "\u0421\u043D\u0430\u0447\u0430\u043B\u0430 \u043E\u0442\u043A\u0440\u0443\u0442\u0438\u0442\u0438\u0435";
				...
				&& (2 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip48 ? (world.getBlockState(BlockPos.containing(X, Y, Z))).getValue(_getip48) : -1)
						|| 5 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip50
								? (world.getBlockState(BlockPos.containing(X, Y, Z))).getValue(_getip50)
								: -1))
				|| Ssc14ModBlocks.ARMORED_WINDOW.get() == (world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock()
						&& (0 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip54
								? (world.getBlockState(BlockPos.containing(X, Y, Z))).getValue(_getip54)
								: -1)
								|| 3 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip56
			...
			loc_buf_t = "\u0421\u0432\u0430\u0440\u043A\u0430";
				...
				&& (1 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip60 ? (world.getBlockState(BlockPos.containing(X, Y, Z))).getValue(_getip60) : -1)
						|| 7 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip62
				...
				|| Ssc14ModBlocks.BASE_WINDOW.get() == (world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock()
						&& 0 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip66
								? (world.getBlockState(BlockPos.containing(X, Y, Z))).getValue(_getip66)
								: -1)
				|| Ssc14ModBlocks.ARMORED_WINDOW.get() == (world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock()
						&& (1 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip70
								? (world.getBlockState(BlockPos.containing(X, Y, Z))).getValue(_getip70)
								: -1)
								|| 4 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip72
										? (world.getBlockState(BlockPos.containing(X, Y, Z))).getValue(_getip72)
										: -1))) {
			loc_buf_t = "\u041E\u0442\u0432\u0451\u0440\u0442\u043A\u0430";
		} else if (Ssc14ModBlocks.PLASTEEL_WALL.get() == (world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock()
				&& 4 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip76 ? (world.getBlockState(BlockPos.containing(X, Y, Z))).getValue(_getip76) : -1)
				|| Ssc14ModBlocks.BASE_WINDOW.get() == (world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock()
						&& 1 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip80
								? (world.getBlockState(BlockPos.containing(X, Y, Z))).getValue(_getip80)
								: -1)
				|| Ssc14ModBlocks.ARMORED_WINDOW.get() == (world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock()
						&& 5 == ((world.getBlockState(BlockPos.containing(X, Y, Z))).getBlock().getStateDefinition().getProperty("blockstate") instanceof IntegerProperty _getip84
