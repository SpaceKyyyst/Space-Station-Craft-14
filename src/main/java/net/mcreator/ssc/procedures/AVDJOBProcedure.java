			...
			Ssc14Mod.queueServerWork(1, () -> {
				if ((entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Ssc14ModMenus.MenuAccessor _menu3 ? _menu3.getSlots().get(0).getItem() : ItemStack.EMPTY).getOrDefault(DataComponents.CUSTOM_DATA, CustomData.EMPTY)
					...
					if (entity instanceof Player _player && _player.containerMenu instanceof Ssc14ModMenus.MenuAccessor _menu)
						_menu.sendMenuStateUpdate(_player, 0, "Job_Name", "\u0410\u0433\u0435\u043D\u0442 \u0432\u043D\u0443\u0442\u0440\u0435\u043D\u043D\u0438\u0445 \u0434\u0435\u043B", true);
					(entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Ssc14ModMenus.MenuAccessor _menu145 ? _menu145.getSlots().get(1).getItem() : ItemStack.EMPTY).set(DataComponents.CUSTOM_NAME, Component
							.literal(("ID \u043A\u0430\u0440\u0442\u0430 (" + ((entity instanceof Player _entity144 && _entity144.containerMenu instanceof Ssc14ModMenus.MenuAccessor _menu144) ? _menu144.getMenuState(0, "Job_Name", "") : "") + ")")));
					if (!world.isClientSide()) {
						BlockPos _bp = BlockPos.containing(x, y, z);
						BlockEntity _blockEntity = world.getBlockEntity(_bp);
						BlockState _bs = world.getBlockState(_bp);
