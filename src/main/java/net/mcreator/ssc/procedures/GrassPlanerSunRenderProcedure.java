...
public class GrassPlanerSunRenderProcedure {
	...
	private static void execute(@Nullable Event event, Entity entity, RenderLevelStageEvent.AfterSky skyRenderEvent) {
		if (entity == null || skyRenderEvent == null)
			return;
		if ((entity.level().dimension()) == ResourceKey.create(Registries.DIMENSION, ResourceLocation.parse("ssc_14:planet_pl"))) {
			RenderUtils.renderCustomSun(skyRenderEvent, ResourceLocation.parse("ssc_14:textures/grass_planet_sun.png"));
		}
	}
}