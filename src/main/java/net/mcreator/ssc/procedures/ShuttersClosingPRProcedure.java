...
public class ShuttersClosingPRProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, BlockState blockstate, Entity entity) {
		if (entity == null)
			return;
		if (Ssc14ModBlocks.SHUTTERS.get() == (world.getBlockState(BlockPos.containing(x, y, z))).getBlock()) {
			if (true == (getPropertyByName((world.getBlockState(BlockPos.containing(x, y, z))), "open") instanceof BooleanProperty _getbp3 && (world.getBlockState(BlockPos.containing(x, y, z))).getValue(_getbp3))
				...
				if (Ssc14ModBlocks.SHUTTERS.get() == (world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock()
						&& true == (getPropertyByName((world.getBlockState(BlockPos.containing(x, y + 1, z))), "open") instanceof BooleanProperty _getbp9 && (world.getBlockState(BlockPos.containing(x, y + 1, z))).getValue(_getbp9))) {
					ShuttersClosingPRProcedure.execute(world, x, y + 1, z, blockstate, entity);
				} else {
			...
			} else if (true == (getPropertyByName((world.getBlockState(BlockPos.containing(x, y, z))), "open") instanceof BooleanProperty _getbp14 && (world.getBlockState(BlockPos.containing(x, y, z))).getValue(_getbp14))
			...
			} else if (false == (getPropertyByName((world.getBlockState(BlockPos.containing(x, y, z))), "open") instanceof BooleanProperty _getbp23 && (world.getBlockState(BlockPos.containing(x, y, z))).getValue(_getbp23))
