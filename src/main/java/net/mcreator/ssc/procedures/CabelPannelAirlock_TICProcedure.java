...
public class CabelPannelAirlock_TICProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		if (entity == null)
			return;
		if (!((Ssc14ModBlocks.BASE_AIRLOCK_D_1
				.get() == (world
						.getBlockState(
								new BlockPos(
										...
										entity.level().clip(new ClipContext(entity.getEyePosition(1f), entity.getEyePosition(1f).add(entity.getViewVector(1f).scale(5)), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, entity)).getBlockPos()
												.getZ())))
						.getBlock()
				|| Ssc14ModBlocks.BASE_AIRLOCK_D_1OPEN
						.get() == (world
				...
				&& true == ((world.getBlockState(
						...
						.getBlock().getStateDefinition().getProperty("panel_open") instanceof BooleanProperty _getbp14
