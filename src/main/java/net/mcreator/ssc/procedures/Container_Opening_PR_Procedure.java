    ...
    public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
        ...
        if (Ssc14ModItems.FLOUR.get() == (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()) {
            if (world instanceof Level _level) {
                if (!_level.isClientSide()) {
                    var soundHolder = BuiltInRegistries.SOUND_EVENT.get(Identifier.fromNamespaceAndPath("ssc_14", "package_opening")).orElse(null);
                    // ИСПРАВЛЕНО: Дописан вызов метода .value() для получения SoundEvent из Holder.Reference под NeoForge 26.1.2
                    if (soundHolder != null) _level.playSound(null, BlockPos.containing(x, y, z), soundHolder.value(), SoundSource.MASTER, 1, (float) Mth.nextDouble(RandomSource.create(), 0.9, 1.1));
                }
            }
            itemstack.shrink(1);
        ...
        // ===== САХАР =====
            ...
            if (world instanceof Level _level) {
                if (!_level.isClientSide()) {
                    var soundHolder = BuiltInRegistries.SOUND_EVENT.get(Identifier.fromNamespaceAndPath("ssc_14", "package_opening")).orElse(null);
                    // ИСПРАВЛЕНО: Дописан вызов метода .value()
                    if (soundHolder != null) _level.playSound(null, BlockPos.containing(x, y, z), soundHolder.value(), SoundSource.MASTER, 1, (float) Mth.nextDouble(RandomSource.create(), 0.9, 1.1));
                }
            }
            itemstack.shrink(1);
        ...
        // ===== МОЛОКО =====
            ...
            if (world instanceof Level _level) {
                if (!_level.isClientSide()) {
                    var soundHolder = BuiltInRegistries.SOUND_EVENT.get(Identifier.fromNamespaceAndPath("ssc_14", "items_bottle_open")).orElse(null);
                    // ИСПРАВЛЕНО: Дописан вызов метода .value()
                    if (soundHolder != null) _level.playSound(null, BlockPos.containing(x, y, z), soundHolder.value(), SoundSource.MASTER, 1, (float) Mth.nextDouble(RandomSource.create(), 0.9, 1.1));
                }
            }
