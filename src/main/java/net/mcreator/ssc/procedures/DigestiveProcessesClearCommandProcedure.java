...
public class DigestiveProcessesClearCommandProcedure {
	public static void execute(CommandContext<CommandSourceStack> arguments) {
		...
		if ((commandParameterEntity(arguments, "ent")) instanceof LivingEntity _livingEntity3 && _livingEntity3.getAttributes().hasAttribute(Ssc14ModAttributes.FLUID_ABSORPTION))
			_livingEntity3.getAttribute(Ssc14ModAttributes.FLUID_ABSORPTION).setBaseValue(0);
	}
