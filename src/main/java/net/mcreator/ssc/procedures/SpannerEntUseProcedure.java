...
public class SpannerEntUseProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, Entity sourceentity) {
		...
		if (entity instanceof WallCarcaseEntitEntity && (sourceentity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem() == Ssc14ModItems.SPANNER.get()) {
										...
										if (sourceentity.getX() + sourceentity.getZ()
											...
											Ssc14Mod.queueServerWork(2, () -> {
												if (sourceentity.getX() + sourceentity.getZ()
														...
														&& (world.getBlockState(BlockPos.containing(entity.getX(), entity.getY(), entity.getZ()))).is(BlockTags.create(ResourceLocation.parse("ssc14:airs")))) {
													if (sourceentity instanceof LivingEntity _livingEntity111 && _livingEntity111.getAttributes().hasAttribute(Ssc14ModAttributes.PROGRESS_BAR_ATRB))
													...
													if (sourceentity instanceof LivingEntity _livingEntity120 && _livingEntity120.getAttributes().hasAttribute(Ssc14ModAttributes.PROGRESS_BAR_ATRB))
			...
			if ((sourceentity instanceof LivingEntity _livingEntity130 && _livingEntity130.getAttributes().hasAttribute(Ssc14ModAttributes.ENT_PULL) ? _livingEntity130.getAttribute(Ssc14ModAttributes.ENT_PULL).getValue() : 0) == 1
