...
public class ShuttersBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(0, ItemStack.EMPTY);

	public ShuttersBlockEntity(BlockPos position, BlockState state) {
		super(Ssc14ModBlockEntities.SHUTTERS.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("shutters");
	}
