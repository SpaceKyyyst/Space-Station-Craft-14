...
public class PodstationBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(9, ItemStack.EMPTY);

	public PodstationBlockEntity(BlockPos position, BlockState state) {
		super(Ssc14ModBlockEntities.PODSTATION.get(), position, state);
	}
