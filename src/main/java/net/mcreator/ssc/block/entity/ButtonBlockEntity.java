...
public class ButtonBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.withSize(0, ItemStack.EMPTY);

	public ButtonBlockEntity(BlockPos position, BlockState state) {
		super(Ssc14ModBlockEntities.BUTTON.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("button");
	}
