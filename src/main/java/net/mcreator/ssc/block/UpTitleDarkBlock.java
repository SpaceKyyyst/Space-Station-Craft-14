...
import net.mcreator.ssc.procedures.CeilingPlacementConditionsProcedure;

public class UpTitleDarkBlock extends Block {
	public UpTitleDarkBlock(BlockBehaviour.Properties properties) {
	...
	public boolean canSurvive(BlockState blockstate, LevelReader worldIn, BlockPos pos) {
		if (worldIn instanceof LevelAccessor world) {
			...
			int y = pos.getY();
			int z = pos.getZ();
			return CeilingPlacementConditionsProcedure.execute(world, x, y, z);
		}
