...
public class ModelConsole_of_ID_DisConnected_ENTITY extends EntityModel<LivingEntityRenderState> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(Identifier.fromNamespaceAndPath("ssc_14", "model_console_of_id_dis_connected_entity"), "main");
