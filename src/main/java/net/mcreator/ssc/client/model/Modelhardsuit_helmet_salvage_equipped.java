...
public class Modelhardsuit_helmet_salvage_equipped extends EntityModel<LivingEntityRenderState> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("ssc_14", "modelhardsuit_helmet_salvage_equipped"), "main");
