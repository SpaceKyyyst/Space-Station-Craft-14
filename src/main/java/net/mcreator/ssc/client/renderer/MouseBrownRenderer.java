...
public class MouseBrownRenderer extends MobRenderer<MouseBrownEntity, LivingEntityRenderState, Modelmouses> {
	private MouseBrownEntity entity = null;
	private final ResourceLocation entityTexture = ResourceLocation.parse("ssc_14:textures/entities/mouse_brown_texture.png");
