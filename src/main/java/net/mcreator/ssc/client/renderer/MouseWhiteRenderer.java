...
public class MouseWhiteRenderer extends MobRenderer<MouseWhiteEntity, LivingEntityRenderState, Modelmouses> {
	private MouseWhiteEntity entity = null;
	private final ResourceLocation entityTexture = ResourceLocation.parse("ssc_14:textures/entities/mouse_white_texture.png");
