...
public class HelmetsEvaCAPIRenderer implements ICurioRenderer.HumanoidRender {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("ssc_14:textures/entities/helmets_eva_equipped_texture.png");
