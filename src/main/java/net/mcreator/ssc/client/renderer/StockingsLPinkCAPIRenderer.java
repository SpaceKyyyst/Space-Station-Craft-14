...
public class StockingsLPinkCAPIRenderer implements ICurioRenderer.HumanoidRender {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("ssc_14:textures/entities/stockings_lpink_equipped_texture.png");
