...
public class OuterclothingEvaCAPIRenderer implements ICurioRenderer.HumanoidRender {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("ssc_14:textures/entities/outerclothing_eva_equipped_texture.png");
