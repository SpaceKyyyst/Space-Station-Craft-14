...
import net.mcreator.ssc.client.model.Modelbelt;
...
public class BeltSecurityCAPIRenderer implements ICurioRenderer.HumanoidRender {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("ssc_14:textures/entities/belt_security_texture.png");
	private final HumanoidModel humanoidModel;

	public BeltSecurityCAPIRenderer() {
        Modelbelt model = new Modelbelt(Minecraft.getInstance().getEntityModels().bakeLayer(Modelbelt.LAYER_LOCATION));
