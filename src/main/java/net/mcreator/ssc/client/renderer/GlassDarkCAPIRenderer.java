...
public class GlassDarkCAPIRenderer<S extends LivingEntityRenderState, M extends EntityModel<? super S>> implements ICurioRenderer.HumanoidRender {
	private static final Identifier TEXTURE = Identifier.parse("ssc_14:textures/entities/glass_dark_equipped_texture.png");
	private final HumanoidModel humanoidModel;

	public GlassDarkCAPIRenderer() {
