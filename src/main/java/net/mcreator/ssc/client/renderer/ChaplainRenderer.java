...
public class ChaplainRenderer<S extends LivingEntityRenderState, M extends EntityModel<? super S>> implements ICurioRenderer.HumanoidRender {
	private static final Identifier TEXTURE = Identifier.parse("ssc_14:textures/entities/jumpsuit_chaplain_equipped_texture.png");
	private final HumanoidModel humanoidModel;

	public ChaplainRenderer() {
