...
import net.mcreator.ssc.client.model.Modelcloak_equipped;
...
public class CloaksHoSCAPIRenderer<S extends LivingEntityRenderState, M extends EntityModel<? super S>> implements ICurioRenderer.HumanoidRender {
	private static final Identifier TEXTURE = Identifier.parse("ssc_14:textures/entities/cloak_hos_equipped_texture.png");
	private final HumanoidModel humanoidModel;

	public CloaksHoSCAPIRenderer() {
        Modelcloak_equipped model = new Modelcloak_equipped(Minecraft.getInstance().getEntityModels().bakeLayer(Modelcloak_equipped.LAYER_LOCATION));
