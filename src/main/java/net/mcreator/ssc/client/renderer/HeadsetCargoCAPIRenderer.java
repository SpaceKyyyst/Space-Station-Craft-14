...
public class HeadsetCargoCAPIRenderer implements ICurioRenderer.HumanoidRender {
	private static final ResourceLocation TEXTURE = ResourceLocation.parse("ssc_14:textures/entities/headset_cargo_equipped_texture.png");
