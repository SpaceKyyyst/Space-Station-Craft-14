...
public class DeconstructPParticle extends SingleQuadParticle {
	...
	public static class DeconstructPParticleProvider implements ParticleProvider<SimpleParticleType> {
		...
		public DeconstructPParticleProvider(SpriteSet spriteSet) { this.spriteSet = spriteSet; }
	...
	public void extract(QuadParticleRenderState particleTypeRenderState, Camera camera, float partialTicks) {
		Vec3 vec = DeconstructPORIENTProcedure.execute(); // ИСПРАВЛЕНО: убраны аргументы
