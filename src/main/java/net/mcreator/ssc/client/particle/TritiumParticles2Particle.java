...
public class TritiumParticles2Particle extends TextureSheetParticle {
	...
	public static class TritiumParticles2ParticleProvider implements ParticleProvider<SimpleParticleType> {
		private final SpriteSet spriteSet;

		public TritiumParticles2ParticleProvider(SpriteSet spriteSet) {
