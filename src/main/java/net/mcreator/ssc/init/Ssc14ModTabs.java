...
public class Ssc14ModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> SSC_14_COATING = REGISTRY.register("ssc_14_coating",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.ssc_14.ssc_14_coating")).icon(() -> new ItemStack(Ssc14ModBlocks.TITLE_STEEL.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(Ssc14ModBlocks.TITLEEIGHTIES.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLEARCADEBLUE_2.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_ARCADEBLUE.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_ARCADERED.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_CARPETOFFICE.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_CARPETCLOWN.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_LAUNDRY.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_BLUE.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_CLOWN.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_BAR.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_CAFETERIA.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_MIME.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_KITCHEN.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_CHECKERDARK.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_LIME.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_HYDRO.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_BOXING.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_GYM.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_LINO.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_FREEZER.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_GOLD.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_SILVER.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_REDCIRCUIT.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_GREENCIRCUIT.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_BLUE_CIRCUIT.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_SHOWROOM.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_MININGFLOORDARK.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_MININGFLOORLIGHT.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_MININGFLOOR.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_MONO.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_SHUTTLEBLACK.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_SHUTTLEBLUE.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_SHUTTLEGREY.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_SHUTTLEORANGE.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_SHUTTLEPURPLE.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_SHUTTLERED.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_SHUTTLEWHITE.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_REINFORCED.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_SUPERREINFORCED.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_METALDIAMOND.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_TECHMAINTDARK.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_TECHMAINT.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_STEELMAINT.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_GRATINGMAINT.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_WOOD.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_WOODTILE.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_WOODLARGE.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_WOODBROKEN.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_STEELDAMAGED.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_STEELDIRTY.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_MEAT.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_ELEVATORSHAFT.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_EXOBORG.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_DARKTEST.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_HULLREINFORCED.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_HULL.get().asItem());
				tabData.accept(Ssc14ModBlocks.TITLE_ROCKVAULT.get().asItem());
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> SSC_14_OBJECTS = REGISTRY.register("ssc_14_objects",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.ssc_14.ssc_14_objects")).icon(() -> new ItemStack(Ssc14ModBlocks.CONSOLE_OF_ID.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(Ssc14ModBlocks.ATMOSPHERICS_AIRLOCK_D_1.get().asItem());
				tabData.accept(Ssc14ModBlocks.CARGO_AIRLOCK_D_1.get().asItem());
				tabData.accept(Ssc14ModBlocks.CENT_COM_AIRLOCK_D_1.get().asItem());
				tabData.accept(Ssc14ModBlocks.CHEMISTRY_AIRLOCK_D_1.get().asItem());
				tabData.accept(Ssc14ModBlocks.COMMAND_AIRLOCK_D_1.get().asItem());
				tabData.accept(Ssc14ModBlocks.ENGINEERING_AIRLOCK_D_1.get().asItem());
				tabData.accept(Ssc14ModBlocks.HYDROPONICS_AIRLOCK_D_1.get().asItem());
				tabData.accept(Ssc14ModBlocks.MEDICAL_AIRLOCK_D_1.get().asItem());
				tabData.accept(Ssc14ModBlocks.SALVAGE_AIRLOCK_D_1.get().asItem());
				tabData.accept(Ssc14ModBlocks.SCIENCE_AIRLOCK_D_1.get().asItem());
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> SSC_14_ITEMS = REGISTRY.register("ssc_14_items",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.ssc_14.ssc_14_items")).icon(() -> new ItemStack(Ssc14ModItems.GLASS.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(Ssc14ModItems.MULTITUL.get());
				...
				tabData.accept(Ssc14ModItems.FLOUR.get());
				tabData.accept(Ssc14ModItems.SUGAR.get());
				tabData.accept(Ssc14ModItems.MILK.get());
				tabData.accept(Ssc14ModItems.ALL_PURPOSE_SAUCE.get());
				tabData.accept(Ssc14ModItems.EGG_CARTON.get());
				tabData.accept(Ssc14ModItems.EGG.get());
				tabData.accept(Ssc14ModItems.DOUGH.get());
				tabData.accept(Ssc14ModItems.DOUGH_PIECE.get());
				tabData.accept(Ssc14ModItems.CHEESE_WHEEL.get());
				tabData.accept(Ssc14ModItems.CHEESE.get());
				tabData.accept(Ssc14ModItems.TOFU.get());
				tabData.accept(Ssc14ModItems.TOFU_SLICE.get());
				tabData.accept(Ssc14ModItems.CUTLET.get());
				tabData.accept(Ssc14ModItems.FRIED_CUTLET.get());
				tabData.accept(Ssc14ModItems.MEAT.get());
				tabData.accept(Ssc14ModItems.FRIED_MEAT.get());
				tabData.accept(Ssc14ModItems.POTATO.get());
				tabData.accept(Ssc14ModItems.BREAD.get());
				tabData.accept(Ssc14ModItems.BREAD_SLICE.get());
				tabData.accept(Ssc14ModItems.BUN.get());
				tabData.accept(Ssc14ModItems.TOFU_BURGER.get());
				tabData.accept(Ssc14ModItems.CHEESEBURGER.get());
				tabData.accept(Ssc14ModItems.CATBURGER.get());
				tabData.accept(Ssc14ModItems.SPACE_FRIES.get());
				...
				tabData.accept(Ssc14ModItems.HEADSET_SERVICE.get());
				tabData.accept(Ssc14ModItems.HEADSET_CARGO.get());
				tabData.accept(Ssc14ModItems.HEADSET_MINING.get());
				tabData.accept(Ssc14ModItems.HEADSET_MEDICAL.get());
				tabData.accept(Ssc14ModItems.HEADSET_ENGINEERING.get());
				tabData.accept(Ssc14ModItems.HEADSET_MEDICAL_SCIENCE.get());
				tabData.accept(Ssc14ModItems.HEADSET_ROBOTICS.get());
				tabData.accept(Ssc14ModItems.HEADSET_SCIENCE.get());
				tabData.accept(Ssc14ModItems.HEADSET_BRIGMEDIC.get());
				tabData.accept(Ssc14ModItems.HEADSET_SECURITY.get());
				tabData.accept(Ssc14ModItems.HEADSET_COMMAND.get());
				tabData.accept(Ssc14ModItems.HEADSET_CENTCOM.get());
				tabData.accept(Ssc14ModItems.HEADSET_SYNDICATE.get());
