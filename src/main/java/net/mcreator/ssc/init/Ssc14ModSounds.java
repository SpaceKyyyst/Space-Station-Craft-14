...
public class Ssc14ModSounds {
	...
	public static final DeferredHolder<SoundEvent, SoundEvent> ITEMS_BOTTLE_OPEN = REGISTRY.register("items_bottle_open", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("ssc_14", "items_bottle_open")));
	public static final DeferredHolder<SoundEvent, SoundEvent> MICROWAVE_START_BEEP = REGISTRY.register("microwave_start_beep", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("ssc_14", "microwave_start_beep")));
	public static final DeferredHolder<SoundEvent, SoundEvent> MICROWAVE_DONE_BEEP = REGISTRY.register("microwave_done_beep", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("ssc_14", "microwave_done_beep")));
	public static final DeferredHolder<SoundEvent, SoundEvent> MICROWAVE_LOOP_6 = REGISTRY.register("microwave_loop_6", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("ssc_14", "microwave_loop_6")));
	public static final DeferredHolder<SoundEvent, SoundEvent> PACKAGE_OPENING = REGISTRY.register("package_opening", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("ssc_14", "package_opening")));
	public static final DeferredHolder<SoundEvent, SoundEvent> CHEMISTRY_BUBBLES = REGISTRY.register("chemistry_bubbles", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("ssc_14", "chemistry_bubbles")));
	public static final DeferredHolder<SoundEvent, SoundEvent> GUNSHOTS_MK58 = REGISTRY.register("gunshots_mk58", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("ssc_14", "gunshots_mk58")));
	public static final DeferredHolder<SoundEvent, SoundEvent> GUNS_BOLT_OPEN = REGISTRY.register("guns_bolt_open", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("ssc_14", "guns_bolt_open")));
	public static final DeferredHolder<SoundEvent, SoundEvent> GUNS_BOLT_CLOSED = REGISTRY.register("guns_bolt_closed", () -> SoundEvent.createVariableRangeEvent(ResourceLocation.fromNamespaceAndPath("ssc_14", "guns_bolt_closed")));
