...
@EventBusSubscriber
public class PDApassangerInventoryCapability extends ComponentItemHandler {
	@SubscribeEvent
	...
	public PDApassangerInventoryCapability(MutableDataComponentHolder parent) {
	...
	public boolean isItemValid(int slot, @Nonnull ItemStack stack) {
		return stack.getItem() != Ssc14ModItems.PD_APASSANGER.get();
	}
