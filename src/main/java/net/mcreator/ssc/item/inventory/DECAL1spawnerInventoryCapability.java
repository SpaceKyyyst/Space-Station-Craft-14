...
@EventBusSubscriber
public class DECAL1spawnerInventoryCapability extends ItemAccessItemHandler {
	@SubscribeEvent
	...
	public DECAL1spawnerInventoryCapability(ItemAccess access) {
	...
	public boolean isValid(int index, ItemResource resource) {
		return super.isValid(index, resource) && resource.getItem() != Ssc14ModItems.DECAL_1SPAWNER.get();
	}
}