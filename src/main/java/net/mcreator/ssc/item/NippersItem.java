...
import net.mcreator.ssc.procedures.Nippers_UseProcedure;
import net.mcreator.ssc.procedures.NippersDAMAGEProcedure;
import net.mcreator.ssc.init.Ssc14ModItems;

@EventBusSubscriber
public class NippersItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, 0, 4f, 0, 1, TagKey.create(Registries.ITEM, ResourceLocation.parse("ssc_14:nippers_repair_items")));
