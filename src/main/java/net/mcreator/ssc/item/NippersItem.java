...
import net.mcreator.ssc.procedures.NippersDAMAGEProcedure;
import net.mcreator.ssc.init.Ssc14ModItems;

@EventBusSubscriber
public class NippersItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, 0, 4f, 0, 1, TagKey.create(Registries.ITEM, Identifier.parse("ssc_14:nippers_repair_items")));

	public NippersItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, -0.9f, -2f, 0)
	...
	public static void modifyDefaultComponents(ModifyDefaultComponentsEvent event) {
		event.modify(Ssc14ModItems.NIPPERS.get(), (builder, _, _) -> builder.set(DataComponents.MAX_DAMAGE, null));
	}
	...
	public void hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		NippersDAMAGEProcedure.execute(entity.level(), entity);
	}
}