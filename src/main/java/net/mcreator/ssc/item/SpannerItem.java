...
import net.mcreator.ssc.procedures.SpannerDAMAGEProcedure;
import net.mcreator.ssc.init.Ssc14ModItems;

@EventBusSubscriber
public class SpannerItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, 0, 4f, 0, 1, TagKey.create(Registries.ITEM, Identifier.parse("ssc_14:spanner_repair_items")));

	public SpannerItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, -0.9f, -2.5f, 0)
	...
	public static void modifyDefaultComponents(ModifyDefaultComponentsEvent event) {
		event.modify(Ssc14ModItems.SPANNER.get(), (builder, _, _) -> builder.set(DataComponents.MAX_DAMAGE, null));
	}
	...
	public void hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		SpannerDAMAGEProcedure.execute(entity.level(), entity);
	}
}