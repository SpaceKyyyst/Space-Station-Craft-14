...
public class ScrewdriverItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, 0, 4f, 0, 1, TagKey.create(Registries.ITEM, Identifier.parse("ssc_14:screwdriver_repair_items")));
	...
	public static void modifyDefaultComponents(ModifyDefaultComponentsEvent event) {
		event.modify(Ssc14ModItems.SCREWDRIVER.get(), (builder, _, _) -> builder.set(DataComponents.MAX_DAMAGE, null));
	}
