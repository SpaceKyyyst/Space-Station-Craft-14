...
public class ScrewdriverItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_WOODEN_TOOL, 0, 4f, 0, 1, TagKey.create(Registries.ITEM, ResourceLocation.parse("ssc_14:screwdriver_repair_items")));

	public ScrewdriverItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 0f, -2f, 0)
	...
	public static void handleToolDamage(ModifyDefaultComponentsEvent event) {
		event.modify(Ssc14ModItems.SCREWDRIVER.get(), builder -> builder.remove(DataComponents.MAX_DAMAGE));
	}
	...
	public InteractionResult useOn(UseOnContext context) {
		super.useOn(context);
		Screwdriver_UseProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(), context.getClickedPos().getZ(), context.getLevel().getBlockState(context.getClickedPos()), context.getPlayer());
