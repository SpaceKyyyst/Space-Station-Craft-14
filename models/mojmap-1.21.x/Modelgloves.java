...
public class Modelgloves<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "gloves"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition r_hand = partdefinition.addOrReplaceChild("r_hand",
				CubeListBuilder.create().texOffs(0, 0).mirror()
						.addBox(-2.0F, -1.8F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.125F)).mirror(false),
		...
		PartDefinition l_hand = partdefinition.addOrReplaceChild("l_hand", CubeListBuilder.create().texOffs(0, 0)
				.addBox(-1.0F, -1.8F, -2.0F, 3.0F, 12.0F, 4.0F, new CubeDeformation(0.125F)),
				PartPose.offset(5.0F, 4.0F, 0.0F));
