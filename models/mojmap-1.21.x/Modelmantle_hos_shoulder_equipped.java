...
public class Modelmantle_hos_shoulder_equipped<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "mantle_hos_shoulder_equipped"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition r_arm = partdefinition.addOrReplaceChild("r_arm", CubeListBuilder.create().texOffs(26, 16)
				.addBox(-2.0F, -2.0F, -2.0F, 3.0F, 20.0F, 4.0F, new CubeDeformation(0.75F)),
		...
		PartDefinition l_arm = partdefinition.addOrReplaceChild("l_arm", CubeListBuilder.create().texOffs(0, 32).addBox(
				-1.0F, -2.0F, -2.0F, 3.0F, 20.0F, 4.0F, new CubeDeformation(0.75F)), PartPose.offset(5.0F, 4.0F, 0.0F));

		PartDefinition r_leg = partdefinition.addOrReplaceChild("r_leg", CubeListBuilder.create().texOffs(32, 0)
				.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.625F)),
				PartPose.offset(-2.0F, 13.0F, 0.0F));

		PartDefinition l_leg = partdefinition.addOrReplaceChild("l_leg", CubeListBuilder.create().texOffs(14, 36)
				.addBox(-2.0F, 0.0F, -2.0F, 4.0F, 9.0F, 4.0F, new CubeDeformation(0.625F)),
				PartPose.offset(2.0F, 13.0F, 0.0F));
